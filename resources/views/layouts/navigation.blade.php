        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="relative flex items-center" 
                        ...
                        <button class="{{ request()->is('sailing*') || request()->routeIs('location.show') 
                        ...
                        <div x-show="open"
                             ...
                             class="absolute z-50 w-48 rounded-md shadow-lg origin-top-left left-0 top-full mt-1"
                             style="display: none;">
                            <div class="rounded-md ring-1 ring-black ring-opacity-5 py-1 bg-white">
                                <a href="/sailing" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                    {{ __('All Posts') }}
                                </a>
                                <a href="{{ route('location.show') }}" class="block px-4 py-2 text-sm leading-5 text-gray-700 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out">
                                    {{ __('Track My Journey') }} 🚢
                                </a>
                            </div>
                        </div>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                @auth
                    ...
                    @else
                        <div class="space-x-4">
                            <x-nav-link :href="route('2fa.challenge')" class="text-red-600">
                                {{ __('Complete 2FA') }}
                            </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @auth
            ...
            @else
                <div class="pt-4 pb-1 border-t border-gray-200">
                    <div class="px-4">
                        <x-responsive-nav-link :href="route('2fa.challenge')" class="text-red-600">
                            {{ __('Complete 2FA') }}
                        </x-responsive-nav-link>
                    </div>
                </div>
